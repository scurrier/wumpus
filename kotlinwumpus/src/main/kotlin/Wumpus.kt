	...
	fun main(args: Array<String>) {
		try {
			...
			while (currentLine <= 1150) {
				...
				10 -> {}					 																	// 10 dim p(5)
				15 -> print("INSTRUCTIONS (Y-N) ")																// 15 print "INSTRUCTIONS (Y-N)";
				20 -> { iS = System.`in`.read().toChar(); System.`in`.read() }	 								// 20 input i$
				...
				245 -> println("HUNT THE WUMPUS")																// 245 print "HUNT THE WUMPUS"
				...
				315 -> {}																						// 315 rem *** LOSE ***
				320 -> println("HA HA HA - YOU LOSE!")															// 320 print "HA HA HA - YOU LOSE!"
				325 -> nextLine = 340																			// 325 goto 340
				330 -> {}																						// 330 rem *** WIN ***
				335 -> println("HEE HEE HEE - THE WUMPUS'LL GET YOU NEXT TIME!!")								// 335 print "HEE HEE HEE - THE WUMPUS'LL GET YOU NEXT TIME!!"
				340 -> j = 1																					// 340 for j = 1 to 6
				345 -> l[j] = m[j]																				// 345 l(j) = m(j)
				350 -> { ++j; if (j <= 6) nextLine = 345 }														// 350 next j
				355 -> print("SAME SETUP (Y-N)")																// 355 print "SAME SETUP (Y-N)";
				360 -> { iS = System.`in`.read().toChar(); System.`in`.read() }									// 360 input i$
				365 -> if (iS != 'Y' && iS != 'y') nextLine = 170												// 365 if (i$ <> "Y") and (i$ <> "y") then 170
				370 -> nextLine = 230																			// 370 goto 230
				375 -> {}																						// 375 rem *** INSTRUCTIONS ***
				380 -> println("WELCOME TO 'HUNT THE WUMPUS'")											 		// 380 print "WELCOME TO 'HUNT THE WUMPUS'"
				385 -> println(																					// 385 print
						"  THE WUMPUS LIVES IN A CAVE OF 20 ROOMS. EACH ROOM")									// "  THE WUMPUS LIVES IN A CAVE OF 20 ROOMS. EACH ROOM"
				390 -> println("HAS 3 TUNNELS LEADING TO OTHER ROOMS. (LOOK AT A")								// 390 print "HAS 3 TUNNELS LEADING TO OTHER ROOMS. (LOOK AT A"
				395 -> println(																					// 395 print
						"DODECAHEDRON TO SEE HOW THIS WORKS-IF YOU DON'T KNOW")									// "DODECAHEDRON TO SEE HOW THIS WORKS-IF YOU DON'T KNOW"
				400 -> println("WHAT A DODECAHEDRON IS, ASK SOMEONE)")											// 400 print "WHAT A DODECAHEDRON IS, ASK SOMEONE)"
				405 -> println("")																				// 405 print
				410 -> println("     HAZARDS:")																	// 410 print "     HAZARDS:"
				415 -> println(																					// 415 print
						" BOTTOMLESS PITS - TWO ROOMS HAVE BOTTOMLESS PITS IN THEM")							// " BOTTOMLESS PITS - TWO ROOMS HAVE BOTTOMLESS PITS IN THEM"
				420 -> println(																					// 420 print
						"     IF YOU GO THERE, YOU FALL INTO THE PIT (& LOSE!)")								// "     IF YOU GO THERE, YOU FALL INTO THE PIT (& LOSE!)"
				425 -> println(																					// 425 print
						" SUPER BATS - TWO OTHER ROOMS HAVE SUPER BATS. IF YOU")								// " SUPER BATS - TWO OTHER ROOMS HAVE SUPER BATS. IF YOU"
				430 -> println(																					// 430 print
						"     GO THERE, A BAT GRABS YOU AND TAKES YOU TO SOME OTHER")							// "     GO THERE, A BAT GRABS YOU AND TAKES YOU TO SOME OTHER"
				435 -> println("     ROOM AT RANDOM. (WHICH MAY BE TROUBLESOME)")								// 435 print "     ROOM AT RANDOM. (WHICH MAY BE TROUBLESOME)"
				440 -> { println("HIT RETURN TO CONTINUE"); System.`in`.read() }								// 440 input "HIT RETURN TO CONTINUE";a$
				445 -> println("     WUMPUS:")																	// 445 print "     WUMPUS:"
				450 -> println(																					// 450 print
						" THE WUMPUS IS NOT BOTHERED BY HAZARDS (HE HAS SUCKER")								// " THE WUMPUS IS NOT BOTHERED BY HAZARDS (HE HAS SUCKER"
				455 -> println(" FEET AND IS TOO BIG FOR A BAT TO LIFT).  USUALLY")						 		// 455 print " FEET AND IS TOO BIG FOR A BAT TO LIFT).  USUALLY"
				460 -> println(																					// 460 print
						" HE IS ASLEEP.  TWO THINGS WAKE HIM UP: YOU SHOOTING AN")								// " HE IS ASLEEP.  TWO THINGS WAKE HIM UP: YOU SHOOTING AN"
				465 -> println("ARROW OR YOU ENTERING HIS ROOM.")												// 465 print "ARROW OR YOU ENTERING HIS ROOM."
				470 -> println(																					// 470 print
						"     IF THE WUMPUS WAKES HE MOVES (P=.75) ONE ROOM")									// "     IF THE WUMPUS WAKES HE MOVES (P=.75) ONE ROOM"
				475 -> println(																					// 475 print
						" OR STAYS STILL (P=.25).  AFTER THAT, IF HE IS WHERE YOU")								// " OR STAYS STILL (P=.25).  AFTER THAT, IF HE IS WHERE YOU"
				480 -> println(" ARE, HE EATS YOU UP AND YOU LOSE!")											// 480 print " ARE, HE EATS YOU UP AND YOU LOSE!"
				485 -> println("")																				// 485 print
				490 -> println("     YOU:")																		// 490 print "     YOU:"
				495 -> println(" EACH TURN YOU MAY MOVE OR SHOOT A CROOKED ARROW")						 		// 495 print " EACH TURN YOU MAY MOVE OR SHOOT A CROOKED ARROW"
				500 -> println(																					// 500 print
						"   MOVING:  YOU CAN MOVE ONE ROOM (THRU ONE TUNNEL)")									// "   MOVING:  YOU CAN MOVE ONE ROOM (THRU ONE TUNNEL)"
				505 -> println(																					// 505 print
						"   ARROWS:  YOU HAVE 5 ARROWS.  YOU LOSE WHEN YOU RUN OUT")							// "   ARROWS:  YOU HAVE 5 ARROWS.  YOU LOSE WHEN YOU RUN OUT"
				510 -> println(																					// 510 print
						"   EACH ARROW CAN GO FROM 1 TO 5 ROOMS. YOU AIM BY TELLING")							// "   EACH ARROW CAN GO FROM 1 TO 5 ROOMS. YOU AIM BY TELLING"
				515 -> println(																					// 515 print
						"   THE COMPUTER THE ROOM#S YOU WANT THE ARROW TO GO TO.")								// "   THE COMPUTER THE ROOM#S YOU WANT THE ARROW TO GO TO."
				520 -> println(																					// 520 print
						"   IF THE ARROW CAN'T GO THAT WAY (IF NO TUNNEL) IT MOVES")		 					// "   IF THE ARROW CAN'T GO THAT WAY (IF NO TUNNEL) IT MOVES"
				525 -> println("   AT RANDOM TO THE NEXT ROOM.")												// 525 print "   AT RANDOM TO THE NEXT ROOM."
				530 -> println("     IF THE ARROW HITS THE WUMPUS, YOU WIN.")									// 530 print "     IF THE ARROW HITS THE WUMPUS, YOU WIN."
				535 -> println("     IF THE ARROW HITS YOU, YOU LOSE.")											// 535 print "     IF THE ARROW HITS YOU, YOU LOSE."
				540 -> { println("HIT RETURN TO CONTINUE"); System.`in`.read() }								// 540 input "HIT RETURN TO CONTINUE";a$
				545 -> println("    WARNINGS:")																	// 545 print "    WARNINGS:"
				550 -> println(																					// 550 print
						"     WHEN YOU ARE ONE ROOM AWAY FROM A WUMPUS OR HAZARD,")								// "     WHEN YOU ARE ONE ROOM AWAY FROM A WUMPUS OR HAZARD,"
				555 -> println("     THE COMPUTER SAYS:")														// 555 print "     THE COMPUTER SAYS:"
				560 -> println(" WUMPUS:  'I SMELL A WUMPUS'")													// 560 print " WUMPUS:  'I SMELL A WUMPUS'"
				565 -> println(" BAT   :  'BATS NEARBY'")														// 565 print " BAT   :  'BATS NEARBY'"
				570 -> println(" PIT   :  'I FEEL A DRAFT'")													// 570 print " PIT   :  'I FEEL A DRAFT'"
				575 -> println("")																				// 575 print
				580 -> returnFromGosub()																		// 580 return
				585 -> {}																						// 585 rem *** PRINT LOCATION & HAZARD WARNINGS ***
				590 -> println("")																				// 590 print
				...
				615 -> println("I SMELL A WUMPUS!")																// 615 print "I SMELL A WUMPUS!"
				620 -> nextLine = 640																			// 620 goto 640
				625 -> println("I FEEL A DRAFT")																// 625 print "I FEEL A DRAFT"
				630 -> nextLine = 640																			// 630 goto 640
				635 -> println("BATS NEARBY!")																	// 635 print "BATS NEARBY!"
				640 -> { ++k; if (k <= 3) nextLine = 605 }														// 640 next k
				645 -> { ++j; if (j <= 6) nextLine = 600 }														// 645 next j
				650 -> { print("YOUR ARE IN ROOM "); println(l[1]) }											// 650 print "YOU ARE IN ROOM ";l(1)
				655 -> { print("TUNNELS LEAD TO ")				                                                // 655 print "TUNNELS LEAD TO ";s(l,1);" ";s(l,2);" ";s(l,3)
					print(s[ll][1])
					print(" "); print(s[ll][2])
					print(" "); println(s[ll][3])
				}
				660 -> println("")																				// 660 print
				665 -> returnFromGosub()																		// 665 return
				670 -> {}																						// 670 rem *** CHOOSE OPTION ***
				675 -> print("SHOOT OR MOVE (S-M) ")															// 675 print "SHOOT OR MOVE (S-M)";
				680 -> { iS = System.`in`.read().toChar(); System.`in`.read() }									// 680 input i$
				...
				735 -> print("NO. OF ROOMS (1-5) ")																// 735 print "NO. OF ROOMS (1-5)";
				740 -> j9 = readInt()																			// 740 input j9
				745 -> if (j9 < 1) nextLine = 735																// 745 if j9 < 1 then 735
				750 -> if (j9 > 5) nextLine = 735																// 750 if j9 > 5 then 735
				755 -> k = 1																					// 755 for k = 1 to j9
				760 -> print("ROOM # ")																			// 760 print "ROOM #";
				765 -> p[k] = readInt()																			// 765 input p(k)
				770 -> if (k <= 2) nextLine = 790																// 770 if k <= 2 then 790
				775 -> if (p[k] != p[k-2]) nextLine = 790														// 775 if p(k) <> p(k-2) then 790
				780 -> println("ARROWS AREN'T THAT CROOKED - TRY ANOTHER ROOM")									// 780 print "ARROWS AREN'T THAT CROOKED - TRY ANOTHER ROOM"
				...
				845 -> println("MISSED")																		// 845 print "MISSED"
				...
				905 -> println("AHA! YOU GOT THE WUMPUS!")														// 905 print "AHA! YOU GOT THE WUMPUS!"
				910 -> f = 1																					// 910 f = 1
				915 -> returnFromGosub()																		// 915 return
				920 -> if (ll != l[1]) nextLine = 840															// 920 if l <> l(1) then 840
				925 -> println ("OUCH! ARROW GOT YOU!")															// 925 print "OUCH! ARROW GOT YOU!"
				...
				960 -> println("TSK TSK TSK - WUMPUS GOT YOU!")													// 960 print "TSK TSK TSK - WUMPUS GOT YOU!"
				965 -> f = -1																					// 965 f = -1
				970 -> returnFromGosub()																		// 970 return
				975 -> {}																						// 975 rem *** MOVE ROUTINE ***
				980 -> f = 0																					// 980 f = 0
				985 -> print("WHERE TO ")																		// 985 print "WHERE TO";
				990 -> ll = readInt()																			// 990 input l
				...
				1030 -> print("NOT POSSIBLE - ")																// 1030 print "NOT POSSIBLE -";
				...
				1060 -> println("... OOPS! BUMPED A WUMPUS!")													// 1060 print "... OOPS! BUMPED A WUMPUS!"
				...
				1100 -> println("YYYYIIIIEEEE . . . FELL IN PIT")												// 1100 print "YYYYIIIIEEEE . . . FELL IN PIT"
				1105 -> f = -1																					// 1105 f = -1
				...
				1130 -> println("ZAP--SUPER BAT SNATCH! ELSEWHEREVILLE FOR YOU!")								// 1130 print "ZAP--SUPER BAT SNATCH! ELSEWHEREVILLE FOR YOU!"
